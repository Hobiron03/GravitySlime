namespace UntitledGames.Transforms
{
    ...
    public partial class TransformProEditor
    {
        ...
        public void RotationField()
        {
            ...
            GUILayout.Label(TransformProStyles.Icons.RotationSmall, TransformProStyles.LabelSmallIcon, GUILayout.Width(16), GUILayout.Height(16));
            Rect toggleRect = GUILayoutUtility.GetLastRect();
            toggleRect.width = 20;
            TransformProPreferences.AdvancedRotation = EditorGUI.Foldout(toggleRect, TransformProPreferences.AdvancedRotation, GUIContent.none);
        ...
        private void DrawRotationAdvancedPanel()
        {
            ...
            if (GUILayout.Button(TransformProStyles.Icons.Random, TransformProStyles.Buttons.Icon.Right, GUILayout.Width(19)))
            {
            ...
            GUIContent contentLookAt = new GUIContent("Clipboard", TransformProStyles.Icons.LookAt, TransformProStrings.SystemLanguage.TooltipLookAt);
